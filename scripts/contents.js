...
const cultureTopicQuestion = "关于文化的问题";
const technologyTopicQuestion = "关于科技的问题";
const economicsTopicQuestion = "关于经济的问题";
const societalTopicQuestion = "关于社会的问题";
export const topicsQuestion = [
    cultureTopicQuestion, technologyTopicQuestion, economicsTopicQuestion,societalTopicQuestion
]
